...
function create_post_type_html5()
{
    ...
    register_post_type('Soins', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Soins', 'helium'), // Rename these to suit
            'singular_name' => __('Soins', 'helium'),
            'add_new' => __('Add New', 'helium'),
            'add_new_item' => __('Add New Soin', 'helium'),
            'edit' => __('Edit', 'helium'),
            'edit_item' => __('Edit Soin', 'helium'),
            'new_item' => __('New Soin', 'helium'),
            'view' => __('View Soin', 'helium'),
            'view_item' => __('View Soin', 'helium'),
            'search_items' => __('Search Soin', 'helium'),
            'not_found' => __('No Soin found', 'helium'),
            'not_found_in_trash' => __('Soin Not found in Trash', 'helium')
        ),
        'public' => true,
  ...
  register_taxonomy(
      ...
      'Soins',
      array(
          'label'  => __('Custom Taxonomy', 'helium'),
          'labels' =>
             array(
                  'name' 			=> __('Custom Taxonomies', 'helium'),
                  'singular_name' => __('Custom Taxonomy', 'helium'),
                  'all_items' 	=> __('All Custom Taxonomy', 'helium'),
                  'edit_item' 	=> __('Edit Custom Taxonomy', 'helium'),
                  'view_item' 	=> __('See Custom Taxonomy', 'helium'),
                  'update_item' 	=> __('Update Custom Taxonomy', 'helium'),
                  'add_new_item' 	=> __('Add Custom Taxonomy', 'helium'),
                  'new_item_name' => __('New Custom Taxonomy', 'helium'),
                  'search_items' 	=> __('Search Custom Taxonomy', 'helium'),
                  'popular_items' => __('Popular Custom Taxonomy', 'helium')
             ),
          'hierarchical' => true,
          'public' => true,
          'has_archive' => true,
